"""
===========================================
練習問題3: 名前を覚えるチャットボット（Chapter 4復習）
===========================================

【目的】
MemorySaverを使って複数ターンの会話で
文脈を保持できることを確認します。

【課題】
ユーザーの名前を覚えて、次の会話でも思い出せる
チャットボットを作成してください。

ヒント
- MemorySaverをインポートする
- MemorySaverを初期化してcheckpointerとして設定する
- configでthread_idを指定して会話を識別する

【参考】
- chapter4/memory_saver.py を参考にしてください
"""
...
if __name__ == "__main__":
    ...
    config = {"configurable": {"???": "user-session-1"}}  # キー名を修正
